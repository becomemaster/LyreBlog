...
//将验证码绘入图片
imagestring($im, 5, 3, 2, $verifyCode, $black);    //将验证码写入到图片中

for($i=0;$i<50;$i++)  //加入干扰象素
{
    imagesetpixel($im, rand(0,66) , rand(0,66) , $black);    //加入点状干扰素
    imagesetpixel($im, rand(0,66) , rand(0,66) , $red);
    imagesetpixel($im, rand(0,66) , rand(0,66) , $gray);
